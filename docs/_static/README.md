...
**This component provides specialized functionality for docs/_static in the Active Inference Knowledge Environment.**
...
from active_inference.docs._static import  Static
