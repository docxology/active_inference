...
**This component provides specialized functionality for docs/_templates in the Active Inference Knowledge Environment.**
...
from active_inference.docs._templates import  Templates
