# Search - Agent Development Guide

**Guidelines for AI agents working with Search in the Active Inference Knowledge Environment.**

**"Active Inference for, with, by Generative AI"**

## 🤖 Agent Role & Responsibilities

**What agents should do when working with Search:**
...
**Understanding how Search fits into the platform:**

```
Platform Layer
├── Knowledge Layer (foundations/, mathematics/, implementations/)
├── Platform Layer ← Search
└── Integration Layer (platform/, visualization/, tools/)
```

### Integration Points

**Search integrates with multiple platform components:**
...
**All platform_search development must follow these patterns:**

#### 1. Component Factory Pattern (PREFERRED)
```python
def create_search(config: Dict[str, Any]) -> Search:
    """Create Search using factory pattern with validation"""
...
def test_search_initialization():
    ...
    component = create_search(config.to_dict())
...
**Component**: Search | **Version**: 1.0.0 | **Last Updated**: October 2024
