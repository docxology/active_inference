...
from active_inference.docs.visualization.dashboards import Dashboards
...
```bash
# Run component tests
make test-docs-visualization-dashboards
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd docs/visualization/dashboards
   ```
