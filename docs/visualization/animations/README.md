...
from active_inference.docs.visualization.animations import Animations
...
```bash
# Run component tests
make test-docs-visualization-animations
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd docs/visualization/animations
   ```
