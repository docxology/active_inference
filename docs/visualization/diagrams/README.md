...
from active_inference.docs.visualization.diagrams import Diagrams
...
```bash
# Run component tests
make test-docs-visualization-diagrams
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd docs/visualization/diagrams
   ```
