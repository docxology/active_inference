...
```
research/project_planning/study_design/
...
from active_inference.research.project_planning.study_design import Study Design
...
```bash
# Run component tests
make test-research-project_planning-study_design
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/project_planning/study_design
   ```
