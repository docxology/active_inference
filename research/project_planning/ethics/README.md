...
```
research/project_planning/ethics/
...
from active_inference.research.project_planning.ethics import Ethics
...
```bash
# Run component tests
make test-research-project_planning-ethics
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/project_planning/ethics
   ```
