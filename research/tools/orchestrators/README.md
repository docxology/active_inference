...
from active_inference.research.tools.orchestrators import Orchestrators
...
```bash
# Run component tests
make test-research-tools-orchestrators
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/tools/orchestrators
   ```
