...
**Guidelines for AI agents working with Utilities in the Active Inference Knowledge Environment.**

**"Active Inference for, with, by Generative AI"**

## 🤖 Agent Role & Responsibilities

**What agents should do when working with Utilities:**
...
**Understanding how Utilities fits into the platform:**

```
Platform Layer
├── Knowledge Layer (foundations/, mathematics/, implementations/)
├── Platform Layer ← Utilities
└── Integration Layer (platform/, visualization/, tools/)
```

### Integration Points

**Utilities integrates with multiple platform components:**
...
```python
def create_utilities(config: Dict[str, Any]) -> Utilities:
    """Create Utilities using factory pattern with validation"""

    # Validate configuration
    validate_utilities_config(config)

    # Create component with validation
    component = Utilities(config)
...
```python
def test_utilities_initialization():
    ...
    component = create_utilities(config.to_dict())
...
component = Utilities(debug_config)
```
