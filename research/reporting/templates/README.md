...
from active_inference.research.reporting.templates import Templates
...
```bash
# Run component tests
make test-research-reporting-templates
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/reporting/templates
   ```
