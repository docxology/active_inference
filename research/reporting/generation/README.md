...
from active_inference.research.reporting.generation import Generation
...
```bash
# Run component tests
make test-research-reporting-generation
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/reporting/generation
   ```
