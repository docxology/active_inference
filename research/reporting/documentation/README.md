...
from active_inference.research.reporting.documentation import Documentation
...
```bash
# Run component tests
make test-research-reporting-documentation
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/reporting/documentation
   ```
