...
**Guidelines for AI agents working with Optimization in the Active Inference Knowledge Environment.**

**"Active Inference for, with, by Generative AI"**

## 🤖 Agent Role & Responsibilities

**What agents should do when working with Optimization:**
...
**Understanding how Optimization fits into the platform:**

```
Platform Layer
├── Knowledge Layer (foundations/, mathematics/, implementations/)
├── Platform Layer ← Optimization
└── Integration Layer (platform/, visualization/, tools/)
```

### Integration Points

**Optimization integrates with multiple platform components:**
...
```python
def create_optimization(config: Dict[str, Any]) -> Optimization:
    """Create Optimization using factory pattern with validation"""
...
def test_optimization_initialization():
    ...
    component = create_optimization(config.to_dict())
...
component = Optimization(debug_config)
```
...
**Component**: Optimization | **Version**: 1.0.0 | **Last Updated**: October 2024
