...
```
research/model_development/optimization/
...
from active_inference.research.model_development.optimization import Optimization
...
```bash
# Run component tests
make test-research-model_development-optimization
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/model_development/optimization
   ```
