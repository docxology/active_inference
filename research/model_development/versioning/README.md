...
```
research/model_development/versioning/
...
from active_inference.research.model_development.versioning import Versioning
...
```bash
# Run component tests
make test-research-model_development-versioning
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/model_development/versioning
   ```
