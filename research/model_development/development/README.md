...
```
research/model_development/development/
...
from active_inference.research.model_development.development import Development
...
```bash
# Run component tests
make test-research-model_development-development
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/model_development/development
   ```
