...
```
research/visualization/interactive/
...
from active_inference.research.visualization.interactive import Interactive
...
```bash
# Run component tests
make test-research-visualization-interactive
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/visualization/interactive
   ```
