# Dynamic - Agent Development Guide

**Guidelines for AI agents working with Dynamic in the Active Inference Knowledge Environment.**

**"Active Inference for, with, by Generative AI"**

## 🤖 Agent Role & Responsibilities

**What agents should do when working with Dynamic:**
...
**Understanding how Dynamic fits into the platform:**

```
Platform Layer
├── Knowledge Layer (foundations/, mathematics/, implementations/)
├── Platform Layer ← Dynamic
└── Integration Layer (platform/, visualization/, tools/)
```

### Integration Points

**Dynamic integrates with multiple platform components:**
...
```python
def create_dynamic(config: Dict[str, Any]) -> Dynamic:
    """Create Dynamic using factory pattern with validation"""
...
def test_dynamic_initialization():
    ...
    component = create_dynamic(config.to_dict())
...
def test_dynamic_functionality():
    """Test core Dynamic functionality"""
    config = DynamicConfig(
        component_name="Dynamic",
        config_field="test_value"
    )
...
component = Dynamic(debug_config)
```
...
**Component**: Dynamic | **Version**: 1.0.0 | **Last Updated**: October 2024
