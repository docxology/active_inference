...
```
research/visualization/static_plots/
...
from active_inference.research.visualization.static_plots import Static Plots
...
```bash
# Run component tests
make test-research-visualization-static_plots
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/visualization/static_plots
   ```
