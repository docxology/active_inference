...
```
research/visualization/animations/
...
from active_inference.research.visualization.animations import Animations
...
```bash
# Run component tests
make test-research-visualization-animations
...
1. **Set Up Environment**:
   ```bash
   make setup
   cd research/visualization/animations
   ```
