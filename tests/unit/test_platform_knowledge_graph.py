...
from active_inference.platform.knowledge_graph import KnowledgeGraph, KnowledgeNode, KnowledgeEdge
...
class TestKnowledgeGraph:
    ...
    def knowledge_graph(self):
        ...
        return KnowledgeGraph({"storage_backend": "memory"})
    ...
    def test_knowledge_graph_initialization(self, knowledge_graph):
        ...
        assert hasattr(knowledge_graph, 'semantic_engine')
        assert hasattr(knowledge_graph, 'validator')
    ...
    def test_add_duplicate_node(self, knowledge_graph):
        ...
        assert stored_node.label == "Test Concept 2"
    ...
    def test_get_related_nodes(self, knowledge_graph):
        ...
        node1 = KnowledgeNode(id="node1", label="Node 1", node_type="concept")
        node2 = KnowledgeNode(id="node2", label="Node 2", node_type="concept")
        node3 = KnowledgeNode(id="node3", label="Node 3", node_type="concept")
        ...
        # Add edges
        edge1 = KnowledgeEdge(source="node1", target="node2", relation_type="prerequisite")
        edge2 = KnowledgeEdge(source="node2", target="node3", relation_type="extends")
    ...
    def test_find_shortest_path(self, knowledge_graph):
        ...
        nodes = [
            KnowledgeNode(id="node1", label="Node 1", node_type="concept"),
            KnowledgeNode(id="node2", label="Node 2", node_type="concept"),
            KnowledgeNode(id="node3", label="Node 3", node_type="concept")
        ]
        ...
        edges = [
            KnowledgeEdge(source="node1", target="node2", relation_type="prerequisite"),
            KnowledgeEdge(source="node2", target="node3", relation_type="extends")
        ]
    ...
    def test_get_graph_statistics(self, knowledge_graph):
        ...
        # Add some edges
        for i in range(4):
            edge = KnowledgeEdge(source=f"node{i}", target=f"node{i+1}", relation_type="related")
            knowledge_graph.add_edge(edge)
    ...
    def test_validate_graph(self, knowledge_graph):
        ...
        node1 = KnowledgeNode(id="valid_node1", label="Valid Node 1", node_type="concept")
        node2 = KnowledgeNode(id="valid_node2", label="Valid Node 2", node_type="concept")

        knowledge_graph.add_node(node1)
        knowledge_graph.add_node(node2)

        edge = KnowledgeEdge(source="valid_node1", target="valid_node2", relation_type="related")
        knowledge_graph.add_edge(edge)
    ...
    def test_export_graph(self, knowledge_graph):
        ...
        # Add test data
        node = KnowledgeNode(id="export_test", label="Export Test", node_type="concept")
        knowledge_graph.add_node(node)
    ...
    def test_backup_and_restore_graph(self, knowledge_graph, tmp_path):
        ...
        # Add test data
        node = KnowledgeNode(id="backup_test", label="Backup Test", node_type="concept")
        knowledge_graph.add_node(node)
    ...
    def test_compute_centrality_metrics(self, knowledge_graph):
        ...
        knowledge_graph.add_edge(KnowledgeEdge(source="node0", target="node1", relation_type="related"))
        knowledge_graph.add_edge(KnowledgeEdge(source="node0", target="node2", relation_type="related"))
